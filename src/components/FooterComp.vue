<template>
  <!-- Grid container -->
  <div class="subs-footer container p-3" style="transform: translateY(100px);">
    <section class="">
      <form action="">
        <!--Grid row-->
        <div class="row d-flex justify-content-around">
          ...
          <div class="col-lg-6" style="color:#FFFFFF">
            <h3 class="subscribe-offers fw-bold pt-4">
          ...
          <!--Grid column-->
          <div class="input-comp col-sm-3 pt-4">
            <!-- Email input -->
  ...
  <!-- Footer -->
  <footer class="footer-comp text-center text-lg-start text-muted" id="footer" style="padding-top: 130px;">
    <!-- Section: Links  -->
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <h6 class="text-uppercase fw-bold mb-4" style="color: #9D3207">
              <span class="brand-name">ARTESANIA</span>
            </h6>
            <p class="text-art">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">Detalhes da Entrega</a>
            </p>
            <p>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">Conta</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Gerenciar Entregas</a>
            </p>
            <p>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">EBook Gratuito</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Tutoriais de Uso</a>
            </p>
            <p>
              <a href="#!" class="text-reset">How to - Blog</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Playlist no Youtube</a>
            </p>
          </div>
          <!-- Grid column -->
